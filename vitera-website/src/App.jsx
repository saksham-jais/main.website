...
function Home() {
  ...
  const nextSlide = () => {
    setCurrentSlide((prev) => (prev >= galleryImages.length - visibleSlides ? 0 : prev + 1));
  };

  const prevSlide = () => {
    setCurrentSlide((prev) => (prev <= 0 ? galleryImages.length - visibleSlides : prev - 1));
  };
          ...
          <div className="container hero-container">
            <div className="hero-content">
              ...
              <p className="hero-description">
                ...
                impactful projects to thought-provoking events, Vitera brings together those who believe in the <strong>power of collective effort</strong>.
              </p>
          ...
          <div className="container">
            ...
            <div className="mobile-gallery-container">
              ...
              <div className="mobile-gallery-slider" ref={sliderRef}>
                {galleryImages.map((img, idx) => (
                  <div className="mobile-gallery-slide" key={idx} style={{ minWidth: visibleSlides === 1 ? "100%" : "calc(100% / 3)" }}>
                    <img src={img.src} alt={img.alt} />
                  </div>
                ))}
              </div>
